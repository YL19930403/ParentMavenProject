		...
		<div class="content-wrapper">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="订单编号"
							value="${orders.order_no }" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								...
								value="${orders.order_time_cn}">
						</div>
					</div>
					<div class="col-md-2 title">路线名称</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="路线名称"
							value="${orders.product.product_name }" readonly="readonly">
					</div>

					<div class="col-md-2 title">出发城市</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="出发城市"
							value="${orders.product.city_name }" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								id="datepicker-a6" value="${orders.product.departure_time_cn}"
								readonly="readonly">
						</div>
					</div>
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="出游人数"
							value="${orders.people_count}" readonly="readonly">
					</div>
			...
			<div class="panel panel-default">
				...
				<table id="dataList"
					...
					<tbody>
						<c:forEach var="people" items="${orders.peoples}">

							<tr>
								<td>${people.travellerTypeStr}</td>
								<td><input type="text" size="10" value="${people.name }"
